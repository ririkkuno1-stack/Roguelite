...
namespace TPSRoguelite.UI
{
    ...
    {
        private const string TITLE_SCENE_NAME = "TitleScene";//シーンの名前
        ...
        private void Start()
        {
            ...
            resultView.OnReturnToTitleActiom += ReturnToTitle;
            ...
            else
            {
                ...
                int seconds = Mathf.FloorToInt(resultModel.SuvivedTime - (minutes * 60f));
